...
export default function MapContainer({
  ...
  useEffect(() => {
    ...
    // Coordinates representing the Access Road near our project
    const roadCoords: L.LatLngTuple[] = [
      [15.641750, 73.743842],
      [15.641513, 73.743750],
      [15.640889, 73.743355],
      [15.640682, 73.743417],
    ...
    // Solid dark outline for high contrast against satellite map terrain
    ...
    // Inner bright solid white line representing the road surface
    L.polyline(roadCoords, {
      color: '#ffffff',
      weight: 6,
      opacity: 1.0,
    ...
    // Custom CSS styled divIcon matching the capsule style in reference screenshot
    const accessLabelIcon = L.divIcon({
      className: 'custom-access-road-label-container',
      html: `
        <div style="
          display: flex;
          align-items: center;
    ...
    // Label Marker on the road at 15.641239, 73.743569
    L.marker([15.641239, 73.743569], { 
      icon: accessLabelIcon,
      interactive: false
    }).addTo(map);
